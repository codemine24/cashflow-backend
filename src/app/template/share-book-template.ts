...
export const shareBookTemplate = (data: {
  receiverName: string;
  senderName: string;
  bookName: string;
  role: string;
                ...
                <td style="background-color: #ffffff; padding: 40px 30px;">
                    ...
                    <tr>
                        ...
                        <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 24px;"><strong>${
                          data.senderName
                        }</strong> has shared a book with you on <strong>${
                          config.app_name
                        }</strong>.</p>
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 20px; border: 1px solid #dddddd; border-radius: 5px;">
                            ...
                            <td style="padding: 20px; background-color: #f9fafb;">
                                <p style="margin: 0 0 10px 0; font-size: 16px;"><strong>Book Name:</strong> <span style="color: #4f46e5;">${
                                  data.bookName
                                }</span></p>
                        ...
                        <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 24px;">You can now view and manage this book directly from your dashboard.</p>
