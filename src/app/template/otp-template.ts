...
// export const OTPTemplate = (otp: string, appInfo: null) => {
//   return `
//         <!DOCTYPE html>
//         <html lang="en">
//         <head>
...
//                 }/storage/v1/object/public/assets/" alt="${
//     config.app_name
...
//                     <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 24px;">Thank you for registering with ${
//                       config.app_name
//                     }. To complete your registration and verify your email address, please use the verification code below:</p>
...
//                     <p style="margin: 0 0 10px 0; font-size: 16px; line-height: 24px;">If you didn't create an account with ${
//                       appInfo?.name || config.app_name
...
//                     <p style="margin: 0;">${
//                       appInfo?.address || config.company_address
//                     }</p>
//                     </td>
//                 </tr>
//                 <tr>
